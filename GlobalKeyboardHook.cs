...
namespace ArrowsCursorGUI
{
    internal class GlobalKeyboardHookEventArgs : HandledEventArgs
    {
        ...
        public GlobalKeyboardHookEventArgs(GlobalKeyboardHook.LowLevelKeyboardInputEvent keyboardData,
    ...
    internal class GlobalKeyboardHook : IDisposable
    {
        ...
        public GlobalKeyboardHook(Func<int, KeyboardState, bool> shouldConsume = null)
        {
            ...
            _hookProc = LowLevelKeyboardProc; // we must keep alive _hookProc, because GC is not aware of SetWindowsHookEx behaviour.
        ...
        public IntPtr LowLevelKeyboardProc(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            eventArguments.Handled = consume;
